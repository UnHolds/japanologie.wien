...
export default function KanjiCustomSettings({
  setKanjiList,
  setQuestionTypes,
}: Props) {
  ...
  const loadKanji = () => {
    ...
    toast.info(
      "Found " + kanji_list.length + " out of " + val.length + " kanjis",
    );
  ...
  return (
    <div>
      <div className="flex justify-center gap-6 mb-5">
        ...
        <button
          className="flex bg-sky-700 p-2 rounded md:text-xl text-lg font-bold items-center"
          onClick={loadKanji}
        >
          Load
        </button>
