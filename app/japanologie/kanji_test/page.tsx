...
export default function KanjiTest() {
  ...
  function get_kanji(list: { k: Kanji; qt: QuestionType }[]) {
    ...
    list = list.filter(
      (v) => Object.entries(v.qt).filter((vv) => vv[1] == false).length > 0,
    );
  ...
  return (
    <div>
      <div>
        ...
        <div className="flex justify-center gap-6 mb-5">
          <div className="flex items-center gap-2">
            <input
              ...
              checked={type == "list_draw"}
              onChange={handleOptionChange}
            />
            <label htmlFor="rb1" className="text-xl text-center1">
              Kanji List Draw
            </label>
          </div>
          <div className="flex items-center gap-2">
            <input
              ...
              name="testtype"
              className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
              checked={type == "custom_draw"}
              onChange={handleOptionChange}
            />
            <label htmlFor="rb2" className="text-xl text-center1">
              Kanji Custom Draw
            </label>
          </div>
        </div>
        ...
        <div className="flex justify-center gap-6 mb-5 text-xl font-bold">
