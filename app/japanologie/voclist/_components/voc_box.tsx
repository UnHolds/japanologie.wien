  ...
  return (
    <div className="grid grid-cols-3 p-2 relative">
      <div
        className="group"
        onClick={() => {
          _setHideKanaKanji(!_hideKanaKanji && hideKanaKanji);
        }}
      >
        <div
          className={`w-fit ${_hideKanaKanji ? "blur-lg bg-gray-100 group-hover:blur-none group-hover:bg-inherit" : ""}`}
        >
          {voc.kana}
        </div>
      </div>
      ...
      <div
        ...
        onClick={() => {
          _setHideMeaning(!_hideMeaning && hideMeaning);
        }}
      >
        <div
          className={`w-fit ${_hideMeaning ? "blur-lg bg-gray-100 group-hover:blur-none group-hover:bg-inherit" : ""}`}
        >
          {voc.meaning}
        </div>
      </div>
